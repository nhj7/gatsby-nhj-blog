...
![](https://blog.kakaocdn.net/dn/qnrye/btqClzlNZ73/5BOFZK7I7beHHwIQV8kMO1/img.png)
...
![](https://blog.kakaocdn.net/dn/3UNvA/btqCqNC89Zi/nY8Gr07m5PwDdGzeNKYN8k/img.png)

GCP 접속 후 Compute Engine 선택

**2.1.2 VM 인스턴스 만들기 선택**

![](https://blog.kakaocdn.net/dn/bim06G/btqCqN4d3yO/v5GtVsmlBNgXcTyquZyxm1/img.png)
...
![](https://blog.kakaocdn.net/dn/sJtYd/btqCqNiQzMd/DJGCqdxaFFsOnEy1UnacNK/img.png)
...
![](https://blog.kakaocdn.net/dn/uJmTd/btqCrkndOk5/BOZMYK0udS4h4eckarSOM0/img.png)
...
![](https://blog.kakaocdn.net/dn/syFfB/btqCrktY652/uTPVriUoO1rtxrfAKmPnq0/img.png)

처음 744시간 무료 확인 후 '만들기' 선택!

우측 상단쪽에 744시간 처음 무료 메세지를 확인을 꼭 하시고 '만들기'를 선택해서 만들어줍시다. 

VM 인스턴스를 생성중이라고 나오면서 로딩바가 계속 돌고 있습니다. 

![](https://blog.kakaocdn.net/dn/xzlwS/btqCl9HcIdk/LVnHrmYoKV5IfzprOJH5bk/img.png)

![](https://blog.kakaocdn.net/dn/b0xLtn/btqCpRshEuf/849Jae6r8dL43mn3Wiq0ZK/img.png)

잠시 기다렸더니 저렇게 인스턴스가 만들어진 것을 확인했습니다. 바로 SSH 연결을 눌러서 접속해보겠습니다. 

![](https://blog.kakaocdn.net/dn/c3ztZn/btqCrOO8z7O/xkg2EBC3UMF0eK61bo24Ck/img.png)

![](https://blog.kakaocdn.net/dn/esJbmz/btqCoQAos9k/PSKrykAeWpLNNkOtLzNnL1/img.png)
...
![](https://blog.kakaocdn.net/dn/cN7XDR/btqCrPmYCWh/KjHsjSuLx9iQLx0FtlElpk/img.png)

아까 확인 외부 IP를 크롬으로 접속
...
![](https://blog.kakaocdn.net/dn/oMWX7/btqCoQAoMCY/xEq0GR79k8fejVz0uuGg50/img.png)

다시 해당 아이피로 접속하면~ hello gcp!!!가 보이는 것을 정상적으로 확인했습니다. 

![](https://blog.kakaocdn.net/dn/UDWKW/btqCjQBDAV0/BcjDoUkhkYwxL2Mf7dfOa1/img.png)
...
구글 클라우드 사용 시 비용이 예산보다 초과하거나 결제 금액이 발생하는 경우 알림을 설정할 필요가 있습니다. 예상하지 못한 금액이 발생하면 안되니까요. 바로 알림 설정에 들어가보도록 하겠습니다. 구글 클..

nhj12311.tistory.com](https://nhj12311.tistory.com/318)
...
 [Google Cloud 무료 등급  |  무료 등급 Google Cloud Platform

Google Cloud 무료 등급은 Google Cloud 서비스를 직접 체험해 볼 수 있도록 무료 리소스를 제공합니다. 기본사항부터 파악해야 하는 최초 이용 고객이나 새 솔루션을 사용해보려는 기존 고객 모두 Google Cloud 무료 등급을 이용할 수 있습니다. Google Cloud 무료 등급에는 다음과 같은 2가지 유형이 있습니다. 12개월 무료 체험판 - 모든 Google Cloud 서비스에 사용할 수 있는 $300의 크레딧이 제공됩니다. 항상

cloud.google.com](https://cloud.google.com/free/docs/gcp-free-tier?hl=ko)
